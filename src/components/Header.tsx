...
export default function Header(props: {
	...
	const link =
		'relative text-[17px] font-normal text-neutral-700 after:absolute after:bottom-0 after:left-0 after:h-px after:w-full after:origin-left after:scale-x-0 after:bg-[#0071e3] after:transition-transform after:duration-300 after:ease-out hover:text-neutral-950 hover:after:scale-x-100 dark:text-neutral-300 dark:after:bg-[#2997ff] dark:hover:text-white';
